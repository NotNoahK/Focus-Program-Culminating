...
public class InputManager : MonoBehaviour {
	...
	static string[] joyButtons = {"joystick button 1", "joystick button 3","joystick button 7","joystick button 2","joystick button 4","joystick button 5","joystick button 0"};
